...
namespace UndergroundIRO.BestChangeParserKit.Exceptions
{
    public class BestChangeParserException : Exception
    {
        ...
        public BestChangeParserException()
        {
        }
        ...
        protected BestChangeParserException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
        ...
        public BestChangeParserException(string message) : base(message)
        {
        }
        ...
        public BestChangeParserException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
